...
@click.command()
@click.option('--video_path', default='videos/video4.mp4', help='Path to the input video file.')
@click.option('--low', default=0.5, type=float, help='Low frequency band for EVM.')
@click.option('--high', default=2, type=int, help='High frequency band for EVM.')
